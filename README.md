> :warning: This repo won't receive any regular updates in the forseeable future. I will be updating the EFI whenever I update my own as the repo contains a SMBIOS stripped version of what I daily-drive.
